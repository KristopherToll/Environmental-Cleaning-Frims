...
AZ <- subset(hoovs_sub, StateId != "ID" & StateId != "ID" & StateId != "UT")
ID <- subset(hoovs_sub, StateId != "AZ" & StateId != "ID" & StateId != "UT")
UT <- subset(hoovs_sub, StateId != "AZ" & StateId != "ID" & StateId != "ID")
...
NV_Collection <- subset(NV, NAICS_Des != "Hazardous Waste Treatment and Disposal"
                        ...
                        & NAICS_Des != "SolNV Waste Combustors and Incinerators")
